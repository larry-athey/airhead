...
It's totally up to you which one to use. The SSR is easiest to set up and doesn't require a heat sink if the load is less than 1200 watts _(the heating element used here is only 700 watts, the fan is the other 50 watss)_.
...
_**NOTE:** Turnkey kits for those not comfortable with building this from scratch will be available from [my website](https://panhandleponics.com/) in the coming weeks. There will be a short lead time on all orders to allow for 3D printing of the 3D models._<br><br>
