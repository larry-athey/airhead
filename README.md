...
This project serves to solve this problem and add three user selectable modes.

1. Operate at a constant power level (0% to 100%)
2. Operate at a constant temperature
