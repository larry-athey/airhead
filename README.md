...
It's totally up to you which one to use, the SSR is easiest to set up and doesn't require a heat sink if the load is less than 1200 watts _(the heating element is only 700 watts)_.
