...
_**NOTE:** Turnkey kits for those not comfortable with building this from scratch will be available from [my website](https://panhandleponics.com/) in the coming weeks. There will be a short lead time to allow for 3D printing of the parts._<br><br>
