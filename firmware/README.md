...
The Airhead will start up a WiFi access point with the SSID **"Airhead-Firmware-Updater"** and the password to connect is **"12345678"**. Keep in mind that the Airhead is working without an external antenna, so the reliable WiFi range is limited to just a few feet.
