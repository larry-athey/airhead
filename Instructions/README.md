...
In these examples, I'm using a cheap $65 [Vevor water distiller](https://www.amazon.com/dp/B0CN2SBJLT). No need for an expensive original Air Still for this project. For the sake of simplicity, I will be setting up this Air Still clone to use a solid state relay as a basic PID controller rather than an SCR board. So, the first step is to turn your Air Still upside down and remove the bottom cover.
...
_**NOTE:** Don't panic, the goal here is to have all of the neutral lines connected together, except for the neutral side of the heatng element._
