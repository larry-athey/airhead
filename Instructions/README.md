...
_**NOTE:** Depending on your Air Still (or clone) model, the manufacturer may have put the fan on the switched side of the heating element. This is an absolutely stupid plan, the fan should run continuously. The temperature control should only run the heating element. This may require a simple wiring modification of your unit. Lucky me, this unit actually has that exact design flaw._
