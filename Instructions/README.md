...
In these examples, I'm using a cheap $65 [Vevor water distiller](https://www.amazon.com/dp/B0CN2SBJLT). No need for an expensive original Air Still for this project. For the sake of simplification, I will be setting up this still to use a solid state relay rather than an SCR controller. The first step is to turn your Air Still upside down and remove the bottom cover.
